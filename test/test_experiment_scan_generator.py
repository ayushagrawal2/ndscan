...
class SelectGeneratorClassCase(unittest.TestCase):
    def test_int_dispatches_to_int_variant(self):
        ...
        self.assertIs(
            select_generator_class("centre_span_refining", "int"),
            IntCentreSpanRefiningGenerator,
        )
    ...
    def test_unknown_returns_none(self):
        self.assertIsNone(select_generator_class("nonsense", "int"))
        self.assertIsNone(select_generator_class("nonsense", "float"))
